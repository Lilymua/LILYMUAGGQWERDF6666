...
public class DroneDeliveryCustomer extends Customer {
	...
	public double getDeliveryDistance() {
		double distanceX = (double) Math.pow(0 - super.getLocationX(), 2);
		double distanceY = (double) Math.pow(0 - super.getLocationY(), 2);
		double distance = Math.sqrt(distanceX + distanceY);
		BigDecimal b = new BigDecimal(distance);
		double distanceFinal = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
